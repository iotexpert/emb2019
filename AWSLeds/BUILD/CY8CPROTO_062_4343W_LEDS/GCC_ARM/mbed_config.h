...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "cypresswicedwifi101"                                                                            // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "CYFI_IOT_EXT"                                                                                   // set by application
...
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       WIFI                                                                                             // set by target:CY8CMOD_062_4343W
